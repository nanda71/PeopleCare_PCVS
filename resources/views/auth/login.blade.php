        ...
        <form class="form" method="post" action="{{ route('login') }}">
            ...
            <div class="card card-login card-white">
                <div class="card-header">
                    ...
                    <h1 class="text-dark mb-2">>{{ __('Log in') }}</h1>
                </div>
                <div class="card-body">
                ...
                <div class="card-footer">
                    ...
                    <div class="pull-left">
                        <h6>
                            <p class=text-dark footer-link >Doesn't have an account? <a href="{{ route('register') }}" class="link footer-link">{{ __('Create Account') }}</a></p>
                        </h6>
                    </div>
