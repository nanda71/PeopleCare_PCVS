...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <link id="colorreplace" rel="stylesheet" type="text/css" href="{{asset('gofar/css/colors/blue.css')}}">
        ...
        <title>PeopleCare PCVS Website</title>
    ...
    <body class="antialiased" background-image=" url( {{asset('welcome/images/BG.jpg')}} )">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                    <img class="card-img-top" src="{{ URL::asset('/welcome/images/vaccine_logo2.png/') }}">
                    <h1>PeopleCare PCVS Website</h1>
                </div>
                <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
                    <div class="text-center text-sm text-gray-500 sm:text-left">
                        <a class="btn btn-info" href="/admin/register" >Admin Sign Up</a>
                        <a class="btn btn-info" href="/admin/login" >Admin Log In</a>
                        <a class="btn btn-info" href="/patient/register" >Patient Sign Up</a>
                        <a class="btn btn-info" href="/patient/login" >Patient Log In</a>
