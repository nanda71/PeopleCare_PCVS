<title>Welcome -OnlineArtPerformance-</title>
	<meta charset="UTF-8">
...
{{-- Form Only --}}
    ...
    <script src="{{asset('dancerpage/assets/plugins/alerts-boxes/js/sweetalert.min.js')}}"></script>
	<script src="{{asset('dancerpage/assets/plugins/alerts-boxes/js/sweet-alert-script.js')}}"></script>
